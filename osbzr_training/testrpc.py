...
# 创建一个课程
iRetId = obj_p.execute(DB, 1, PASS, 'training.lesson', 'create',
                       {"name": 'rpc op test16' + str(datetime.datetime.now()),
...
# 用向导对象报名
i_apply_id = obj_p.execute(DB, 1, PASS, 'training.apply', 'create',
                           {"lesson_id": iRetId, "student_ids": [(4, 3), (4, 8)]})
